...
class RecoverPwdEmail extends StatefulWidget {
  const RecoverPwdEmail({super.key});

  @override
  State<RecoverPwdEmail> createState() => _RecoverPwdEmailState();
}

class _RecoverPwdEmailState extends State<RecoverPwdEmail> {
              ...
              Container(
                ...
                child: ListView(
                  ...
                  children: [
                    SizedBox(height: 20),
                    Text(
                      'Um codigo de verificação será enviado para o email cadastrado',
                      style: TextStyle(
                        fontSize: 13,
